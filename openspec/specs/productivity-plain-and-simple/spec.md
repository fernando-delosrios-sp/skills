# productivity-plain-and-simple Specification

## Purpose

Local-only productivity skill `plain-and-simple`: model-invoked clarity-first brevity for user-facing agent messages, distinct from `caveman`.
