# engineering-deploy-mate Specification

## Purpose

End-to-end deployment readiness for one environment via the deploy-mate skill — including runtime visibility: per-component tier-1/tier-2 read paths, tooling preparation, deploy gates, and post-deploy verify execution.
## Requirements
