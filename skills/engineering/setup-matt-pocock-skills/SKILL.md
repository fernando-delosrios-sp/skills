...
When `structured-choices` is installed, after writing docs run its **Install** path ([structured-choices](../structured-choices/SKILL.md#install)) — do not add User gates to the setup AGENTS template; Install owns that content.
...
- [domain.md](./domain.md): domain doc consumer rules + layout (legacy)
- [domain-openspec.md](./domain-openspec.md): domain doc consumer rules + layout (OpenSpec)

When OpenSpec mode is selected, write `docs/agents/domain.md` from [domain-openspec.md](./domain-openspec.md). In legacy mode, use [domain.md](./domain.md).
