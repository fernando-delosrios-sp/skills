 ...
 */
export async function copySkillDir(src, dest) {
...
export async function doImport(
  ...
  category,
  existingNames,
  { cwd = process.cwd(), loadSkillsFn = loadSkills, saveSkillsFn = saveSkills } = {}
) {
...
async function logGeneratorManifest(skillName, { indent = '  ', showCursorHint = false } = {}) {
  try {
    ...
    if (showCursorHint) {
      console.log(kleur.dim('  In Cursor: update-skills apply <name>'));
    }
  } catch (err) {
